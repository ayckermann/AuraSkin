...
var prosIngredientsDummy: [IngredientsEffect] = [
    IngredientsEffect(effect: "Mouisturising", description: "Hydrates the skin", count: 9, ingredients: [
...
//var ingredientsDummy: String = "нутенв вет, Сави яска, жиряси, Potassin Hydroxide, Cellulose, Myristic Acid, Fragrance, Laureth-4 Carboxylic Acrylates/C10-30 Alkyl Acrylate Crosspolymer, Lauryi Hydroxysultaine, Palmitic Acid, Sodium Laureth Sullate, Disodium EDTA, PEG-6, Etidronic Acid, Sodium Bicarbonate, Tocopheryl hoetate, Aluminum Hydroxide, Alcohol, Butylene Clycol, Niacinamide, Tetrasodium EDTA, Camellia Sinensis Lead Extract, Cl 77891"
