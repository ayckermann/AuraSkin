...
//    @State var product: ProductModel = ProductModel(name: "", ingredients: "", category: "Facial Wash", currentlyUsed: true, expiredDate: Date.now, image: UIImage(named: "productImageDefault")?.pngData())
