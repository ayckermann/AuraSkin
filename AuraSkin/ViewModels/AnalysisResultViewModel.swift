...
class AnalysisResultViewModel {
    ...
    func getProsIngredients(data: IngredientsAnalysisResponse) -> [IngredientsEffect] {
        ...
        if let moisturising = data.analysis?.positive.moisturising, moisturising.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: moisturising.title, description: moisturising.description, count: moisturising.count, symbol: "moisturising", ingredients: ingredientList))
        }
        ...
        if let softening = data.analysis?.positive.softening, softening.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: softening.title, description: softening.description, count: softening.count, symbol: "softening", ingredients: ingredientList))
        }
        ...
        if let soothing = data.analysis?.positive.soothing, soothing.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: soothing.title, description: soothing.description, count: soothing.count, symbol: "soothing", ingredients: ingredientList))
        }
        ...
        if let acneFighting = data.analysis?.positive.acneFighting, acneFighting.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: acneFighting.title, description: acneFighting.description, count: acneFighting.count, symbol: "acneFighting", ingredients: ingredientList))
        }
        ...
        if let antiAging = data.analysis?.positive.antiAging, antiAging.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: antiAging.title, description: antiAging.description, count: antiAging.count, symbol: "antiAging", ingredients: ingredientList))
        }
        ...
        if let antioxidant = data.analysis?.positive.antioxidant, antioxidant.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: antioxidant.title, description: antioxidant.description, count: antioxidant.count, symbol: "antioxidant", ingredients: ingredientList))
        }
        ...
        if let healing = data.analysis?.positive.healing, healing.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: healing.title, description: healing.description, count: healing.count, symbol: "healing", ingredients: ingredientList))
        }
        ...
        if let antiseptic = data.analysis?.positive.antiseptic, antiseptic.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: antiseptic.title, description: antiseptic.description, count: antiseptic.count, symbol: "antiseptic", ingredients: ingredientList))
        }
        ...
        if let whitening = data.analysis?.positive.whitening, whitening.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: whitening.title, description: whitening.description, count: whitening.count, symbol: "whitening", ingredients: ingredientList))
        }
        ...
        if let uvProtecting = data.analysis?.positive.uvProtecting, uvProtecting.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: uvProtecting.title, description: uvProtecting.description, count: uvProtecting.count, symbol: "uvProtecting", ingredients: ingredientList))
        }
    ...
    func getConsIngredients(data: IngredientsAnalysisResponse) -> [IngredientsEffect] {
        ...
        if let allergen = data.analysis?.harmful.allergen, allergen.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: allergen.title, description: allergen.description, count: allergen.count, symbol: "allergen", ingredients: ingredientList))
        }
        ...
        if let alcohol = data.analysis?.harmful.alcohol, alcohol.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: alcohol.title, description: alcohol.description, count: alcohol.count, symbol: "alcohol", ingredients: ingredientList))
        }
        ...
        if let comedogenic = data.analysis?.harmful.comedogenicRating, comedogenic.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: comedogenic.title, description: comedogenic.description, count: comedogenic.count, symbol: "comedogenic", ingredients: ingredientList))
        }
        ...
        if let gluten = data.analysis?.harmful.gluten, gluten.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: gluten.title, description: gluten.description, count: gluten.count, symbol: "gluten", ingredients: ingredientList))
        }
        ...
        if let silicone = data.analysis?.harmful.silicone, silicone.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: silicone.title, description: silicone.description, count: silicone.count, symbol: "allergen", ingredients: ingredientList))
        }
        ...
        if let sulfate = data.analysis?.harmful.sulfate, sulfate.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: sulfate.title, description: sulfate.description, count: sulfate.count, symbol: "silicone", ingredients: ingredientList))
        }
        ...
        if let paraben = data.analysis?.harmful.paraben, paraben.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: paraben.title, description: paraben.description, count: paraben.count, symbol: "paraben", ingredients: ingredientList))
        }
        ...
        if let peg = data.analysis?.harmful.peg, peg.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: peg.title, description: peg.description, count: peg.count, symbol: "peg", ingredients: ingredientList))
        }
        ...
        if let fungalAcneFeeding = data.analysis?.harmful.fungalAcneFeeding, fungalAcneFeeding.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: fungalAcneFeeding.title, description: fungalAcneFeeding.description, count: fungalAcneFeeding.count, symbol: "fungalAcneFeeding", ingredients: ingredientList))
        }
        ...
        if let fragrance = data.analysis?.harmful.fragrance, fragrance.count != 0 {
            ...
            ingredientsEffect.append(IngredientsEffect(effect: fragrance.title, description: fragrance.description, count: fragrance.count, symbol: "fragrance", ingredients: ingredientList))
        }
